...
function get_reds(image::AbstractMatrix)
	# your code here!
	return get_red.(image) # note the broadcasting
end
...
value_as_color(0.0, "r"), value_as_color(0.6, "r"), value_as_color(1.0, "r")
...
function red_image(image)
	reds = get_reds(image)
	return value_as_color.(reds, fill("r", size(reds)))
end

# ╔═╡ 2740c74d-e01a-4a6f-b06e-cbb90f6f21fc
red_image(philip)
...
# ╔═╡ 5dfb4e24-f6bc-4d3a-ad9f-50cbac42b68c
function get_greens(image::AbstractMatrix)
	# your code here!
	return get_green.(image) # note the broadcasting
end

# ╔═╡ 6d355f90-de6a-43c0-9ed3-3ee65460b312
function get_blue(pixel::AbstractRGB)
	# your code here!
	return pixel.b
end

# ╔═╡ 0c6b81dd-28d8-4f44-aa4d-1313c0a59cee
function get_blues(image::AbstractMatrix) # takes in an image and returns all the blue component of every pixel
	# your code here!
	return get_blue.(image)
end

# ╔═╡ 7158dffa-239a-4ef5-8e37-a17795aee6d6
function green_image(image)
	greens = get_greens(image)
	return value_as_color.(greens, fill("g", size(greens)))
end

# ╔═╡ 4435fd66-73c0-4bf1-9bd7-464c200d3ff6
function blue_image(image)
	blues = get_blues(image)
	return value_as_color.(blues, fill("b", size(blues)))
end

# ╔═╡ 6981de60-5ced-44d5-9e54-70dbc88bc603
green_image(philip)

# ╔═╡ 9f1bec81-d056-4031-be99-84036e1347f5
blue_image(philip)
...
function noisify(x::Number, s)
	# your code here!
	return clamp((x+ rand()*2s + (-s)), 0, 1) # random value in (-s,s)
end
...
# ╔═╡ af5b7e01-d2ee-4eef-9fe5-efc19afe643c
philip_head
...
The image is unrecognisable with intensity 3.5
"""
...
# ╔═╡ dc76df44-f153-46c9-b8a0-230f1811c44f
