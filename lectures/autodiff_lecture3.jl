...
# ╔═╡ d0c4f23a-a19c-4566-8d03-98059adca6d3
...
begin	
	...
	warp₂(α) = ((x,y),) -> warp₂(α,x,y)([x,y]) # why do i have to call [x,y] again?
end

# ╔═╡ 68d80cd9-43f5-4423-990c-3eb7b2f50b94
md"The warp₂(α,x,y) is just a function, we actually have to pass in the argument (x,y) to the function again; look at the definition of rot; α*√(x^2+y^2) is just the angle by which we wanna rotate, we also gotta pass in the point (x,y) that we actually want to rotate "
...
ForwardDiff.jacobian( warp(3.0), [4,5] ) # finding the derivative AT the point [4,5]
...
# ╔═╡ 9e991be3-798c-47cf-80cc-9cf808751557
∂w∂x

# ╔═╡ 28e01707-e4bf-424c-a980-98970277195d
∂w∂y
...
# ╔═╡ bbe61b06-08fe-4b16-8378-78498ac9744f
md"""
α = $(@bind α Slider(0:0.1:6, show_value=true, default=0))
"""
